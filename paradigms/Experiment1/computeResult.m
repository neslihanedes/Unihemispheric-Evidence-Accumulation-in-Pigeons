function [mono, bino, probe] = computeResult(par, res1, res2)
...
if (isstruct(res2))
    ...
    probeBinoTime1	= probeBino([probeBino.delay] == par.probeDelay(1));
    probeBinoTime2	= probeBino([probeBino.delay] == par.probeDelay(2));
    probeBinoTime3	= probeBino([probeBino.delay] == par.probeDelay(3));
    probeBinoTime4	= probeBino([probeBino.delay] == par.probeDelay(4));
    probeBinoTime5  = probeBino([probeBino.delay] == par.probeDelay(5));
    probeBinoTime6	= probeBino([probeBino.delay] == par.probeDelay(6));
    ...
    probe.correctBinoTime100 	= sum([probeBinoTime1.reward]);
    probe.correctBinoTime200	= sum([probeBinoTime2.reward]);
    probe.correctBinoTime300 	= sum([probeBinoTime3.reward]);
    probe.correctBinoTime400 	= sum([probeBinoTime4.reward]);
    probe.correctBinoTime500 	= sum([probeBinoTime5.reward]);
    probe.correctBinoTime600 	= sum([probeBinoTime6.reward]);
else
    probe = -1;
end
