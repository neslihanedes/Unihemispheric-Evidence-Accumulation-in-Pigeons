...
% 24.04.2018, Tobias: first draft
% 25.04.2018, Tobias: added catch trials
...
par.num = par.numBinoTrials + par.numMonoTrialsL + par.numMonoTrialsR ...
          + par.numProbeTrials + par.numBinoCatchTrials;

buf = randomOrder(10, par.num, 'ratio', ...
    [par.numBinoTrials/2, par.numBinoTrials/2, ...d
    ...
    par.numBinoCatchTrials/2 par.numBinoCatchTrials/2]/par.num, 'nowarning');
